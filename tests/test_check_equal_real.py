...
"""Tests for ``check_real()`` for floating point values."""
...
def test_check_equal_0_0_pass(caplog):
...
def test_check_equal_0_1_pass(caplog):
...
def test_check_equal_0_1_fail(caplog):
...
def test_check_equal_0_1_fail2(caplog):
...
def test_check_equal_my_checker__0_0_pass(caplog):
...
def test_check_equal_my_checker__0_1_pass(caplog):
...
def test_check_equal_my_checker__0_1_fail(caplog):
...
def test_check_equal_my_checker__0_1_fail2(caplog):
